...
class FileConvertor(object):
    ...
    def __init__(self, src, dest, range_file, range_start):
        self._src = os.path.abspath(src)
        self._dest = os.path.abspath(dest)
        self._range_file = os.path.abspath(range_file)
        self._range_start = range_start
        self._dict = self._dest + "dict"
    ...
    def _write_log_method(self, dest_f):
        ...
        try:
            ...
            raise Exception("Unexpected line {} at {}".format(
                self._log_full, self._line_num))
    ...
    @staticmethod
    def convert(src, dest, range_file, range_start):
        convertor = FileConvertor(src, dest, range_file, range_start)
        convertor.run()
...
if __name__ == '__main__':
    ...
    FileConvertor.convert(src, dest, range_file, range_start)
