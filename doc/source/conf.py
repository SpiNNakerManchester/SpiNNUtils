...
project = u'SpiNNUtils'
copyright = u'2014-2023'
...
latex_documents = [
  ('index', 'SpiNNUtils.tex', u'SpiNNUtils Documentation',
   u'', 'manual'),
]
...
man_pages = [
    ('index', 'SpiNNUtils', u'SpiNNUtils Documentation',
     [u''], 1)
]
